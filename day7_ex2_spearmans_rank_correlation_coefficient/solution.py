...
if __name__ == '__main__':
    ...
    #
    x_rank_map = {x: i for i, x in enumerate(sorted(set(xs)))}
    y_rank_map = {y: i for i, y in enumerate(sorted(set(ys)))}

    x_rank = [x_rank_map[x] for x in xs]
    y_rank = [y_rank_map[y] for y in ys]
